...
/**
 * {@link Fragment} to show a person's examinations. 
 * It displays slightly different content based on the person's gender. 
 */
// begin fragment ExaminationsFragment
public class ExaminationsFragment extends Fragment {
     ...
     * The logger.
     */
    private static final String LOG_TAG = ExaminationsFragment.class.getSimpleName();

    /* VARIABLES */

    /* CONSTRUCTOR */

    public ExaminationsFragment() {
        // Required empty public constructor
    }

    /**
     * Create a new {@link ExaminationsFragment} with the given arguments.
     *
     * @param gender The person's gender
     * */
    // begin instantiating method newInstance
    public static ExaminationsFragment newInstance( GENDER gender ) {

        // 0. create a new ExaminationsFragment
        // 1. put the parameters in a bundle
        // 2. use the bundle as the arguments for the created ExaminationsFragment
        // 3. return the created ExaminationsFragment
    ...
    public View onCreateView( LayoutInflater inflater, ViewGroup container,
        ...
        if ( bundle != null ) {
            ...
            if ( gender.equals( GENDER.FEMALE ) ) {
                rootView = inflater.inflate( R.layout.fragment_examination_female, container, false );
            }

            else if ( gender.equals( GENDER.MALE ) ) {
                rootView = inflater.inflate( R.layout.fragment_examination_male, container, false );
            }
            ...
            throw new RuntimeException( "ExaminationsFragment has to have arguments to know the gender!" );
        }
...
} // end fragment ExaminationsFragment
